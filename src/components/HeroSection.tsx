          ...
          <div className="text-white text-center lg:text-left space-y-6 md:space-y-8 order-2 lg:order-1">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl card-padding border border-white/20">
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  <div className="text-responsive-lg font-bold text-green-light">
                    98%
                  </div>
          ...
          <div className="flex justify-center order-1 lg:order-2">
            <div className="relative group max-w-md w-full">
              <div className="relative overflow-hidden rounded-3xl shadow-2xl">
                <img
                  src="imagens/hero-section-pic1.jpg"
                ...
                <div className="absolute bottom-4 md:bottom-6 left-4 md:left-6 right-4 md:right-6">
                  <div className="bg-white/95 backdrop-blur-sm rounded-xl p-3 md:p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="font-poppins font-bold text-green-dark text-sm md:text-base">
                          Ensino de Qualidade
                        </div>
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <span className="text-xs md:text-sm font-semibold text-green-dark">
                          200+ alunos
                        </span>
                      </div>
                    </div>
