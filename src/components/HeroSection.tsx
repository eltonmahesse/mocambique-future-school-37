          ...
          <div className="text-white text-center lg:text-left space-y-dynamic order-2 lg:order-1 hero-content-ultra">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl card-padding border border-white/20">
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  <div className="hero-subtitle font-bold text-green-light">98%</div>
                  <div className="hero-text text-white/80">Taxa de aprovação</div>
                </div>
                <div>
                  <div className="hero-subtitle font-bold text-green-light">200+</div>
                  <div className="hero-text text-white/80">Alunos matriculados</div>
                </div>
                <div>
                  <div className="hero-subtitle font-bold text-green-light">100%</div>
                ...
                <div className="absolute bottom-4 md:bottom-6 left-4 md:left-6 right-4 md:right-6">
                  <div className="bg-white/95 backdrop-blur-sm rounded-xl card-padding">
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="font-poppins font-bold text-green-dark hero-text">Ensino de Qualidade</div>
                        <div className="text-gray-600" style={{ fontSize: 'clamp(0.75rem, 2vw, 0.875rem)' }}>Matola, Moçambique</div>
                      </div>
                      <div className="flex items-center space-x-1">
                        <Users className="text-green-primary" style={{ width: 'clamp(1rem, 3vw, 1.25rem)', height: 'clamp(1rem, 3vw, 1.25rem)' }} />
                        <span className="hero-text font-semibold text-green-dark">200+ alunos</span>
                      </div>
                    </div>
                  </div>
                </div>
