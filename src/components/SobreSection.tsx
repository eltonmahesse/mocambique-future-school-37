        ...
        <div className="grid-responsive-2 items-center">
          ...
          <div className="animate-fade-in order-1 md:order-2">
            <h2 className="font-poppins font-bold text-responsive-xl text-gray-800 mb-4 md:mb-6 text-center md:text-left">
              A nossa missão é educar com <span className="text-green-primary">propósito</span>
            </h2>
            ...
            <div className="space-y-4 md:space-y-6">
              <p className="font-poppins text-responsive-base text-gray-600 leading-relaxed text-center md:text-left">
                ...
                Acreditamos que cada criança tem potencial único e a nossa missão é desenvolver esse potencial através 
              ...
              <p className="font-poppins text-responsive-base text-gray-600 leading-relaxed text-center md:text-left">
                ...
                futuro. A nossa equipa pedagógica qualificada, infraestrutura moderna e valores sólidos fazem do 
                Colégio Pércia a melhor escolha para o desenvolvimento integral dos vossos filhos.
              </p>
            </div>
          </div>
        </div>
