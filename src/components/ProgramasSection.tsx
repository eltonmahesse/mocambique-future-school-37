      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {programas.map((programa, index) => (
            ...
            >
              <div className="bg-white rounded-3xl shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden h-full">
                {/* Imagem */}
                <div className="relative h-48 overflow-hidden">
                  ...
                  />
                  <div className={`absolute top-4 right-4 ${programa.cor} text-white px-3 py-1 rounded-full`}>
                    <span className="font-poppins font-semibold text-sm">{programa.subtitulo}</span>
                  </div>
                </div>

                {/* Conteúdo */}
                <div className="p-6">
                  <h3 className="font-poppins font-bold text-xl text-gray-800 mb-3">
                    {programa.titulo}
                  </h3>
