...
import { Play, Users, GraduationCap, Award } from 'lucide-react';
            ...
            >
              ...
              <div className="relative aspect-video overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="bg-green-primary hover:bg-green-medium text-white p-4 rounded-full shadow-2xl group-hover:scale-110 transition-all duration-300 cursor-pointer">
